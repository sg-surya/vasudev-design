      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 sm:pt-40 pb-20 flex flex-col lg:flex-row gap-8 xl:gap-16">
        ...
        <div className="w-full lg:w-5/12 flex flex-col justify-start">
          ...
          <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <select className="w-full bg-white border border-zinc-200 rounded-xl px-4 py-3 text-[14px] text-zinc-900 focus:outline-none focus:ring-4 focus:ring-zinc-100 focus:border-zinc-300 transition-all shadow-sm appearance-none">
                    <option>React</option>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-[0_4px_12px_rgb(0,0,0,0.05)] border border-zinc-200/80">
                ...
                <textarea 
                  ...
                  defaultValue={'<button className="px-6 py-2 bg-black text-white rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 font-medium">\n  Click me\n</button>'}
                ></textarea>
              </div>
            </div>
            ...
            {/* Submit Button */}
            <div className="pt-4">
              <button className="w-full flex items-center justify-center gap-2 bg-zinc-900 text-white rounded-xl px-6 py-4 text-[15px] font-semibold hover:bg-zinc-800 hover:shadow-lg transition-all active:scale-95 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)]">
          ...
          <div className="sticky top-[104px] w-full h-[700px] border border-zinc-200/80 bg-white rounded-[32px] overflow-hidden shadow-[0_12px_40px_rgba(0,0,0,0.06)] flex flex-col">
            ...
            <div className="h-14 border-b border-zinc-100 flex items-center justify-between px-6 bg-zinc-50/80 backdrop-blur-md">
              ...
              <div className="flex items-center gap-2 px-3 py-1 bg-green-50 rounded-full border border-green-200">
                ...
                <span className="text-[10px] font-bold text-green-700 uppercase tracking-wider">Syncing</span>
              </div>
            </div>
            ...
            <div className="flex-1 relative bg-white flex items-center justify-center p-8 overflow-hidden">
              ...
              <div className="relative z-10 scale-125 bg-white p-12 rounded-[2rem] border border-zinc-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center justify-center">
                 <button className="px-6 py-2 bg-black text-white rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 font-medium">
                   Click me
                 </button>
              </div>
            </div>
